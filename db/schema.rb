...
ActiveRecord::Schema.define(version: 2020_04_05_081545) do
  ...
  create_table "sns_products", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "product_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_sns_products_on_product_id"
    t.index ["user_id"], name: "index_sns_products_on_user_id"
  end
  ...
  add_foreign_key "products", "users", column: "client_id"
  ...
  add_foreign_key "sns_products", "products"
  add_foreign_key "sns_products", "users"
end
